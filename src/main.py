...
from metrics import SIF_SIM, BLEU, JSD, ROUGE_WE, METEOR, JACCARD
import pickle
...
if __name__ == "__main__":
    ...
    cosine_sim = SIF_SIM.compute_cosine_similarity(summary,model_1,"emb_social")
    sif_sim = SIF_SIM.compute_sif_similarity(summary, model_1,"emb_social")
    print(cosine_sim)
    print(sif_sim)
