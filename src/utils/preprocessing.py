...
if __name__=="__main__":
    summary = "I invaded my gfs privacy and discovered a fetish that I find mildly disturbing what the hell the hell should I do?"
    n_g = get_ngrams(summary)
    print(embeddings.get_ngram_embedding(n_g[0],'emb_social'))